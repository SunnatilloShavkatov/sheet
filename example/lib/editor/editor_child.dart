...
class EmptyWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Container(height: 200, alignment: Alignment.topCenter);
}
...
class ColumnWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(
    ...
    children: <Widget>[
      ListTile(title: const Text('Edit'), leading: const Icon(Icons.edit), onTap: () {}),
      ListTile(title: const Text('Copy'), leading: const Icon(Icons.content_copy), onTap: () {}),
      ListTile(title: const Text('Cut'), leading: const Icon(Icons.content_cut), onTap: () {}),
      ListTile(title: const Text('Move'), leading: const Icon(Icons.folder_open), onTap: () {}),
