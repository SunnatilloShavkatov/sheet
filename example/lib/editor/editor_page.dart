        ...
        children: <Widget>[
          BaseScaffold(
            ...
            sheet: Sheet(
              ...
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(configuration.borderRadius ?? 0)),
              elevation: 4,
...
class FilterEditor extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(automaticallyImplyLeading: false, title: const Text('Edit Sheet')),
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ...ListTile.divideTiles(
              ...
              tiles: <Widget>[
                ListTile(
                  title: const Text('Minimum Extent'),
                  trailing: NumTextField(
                    onChanged: (int? value) {
                      controller.value = controller.value.copyWith(minExtent: value?.toDouble());
                    },
                  ),
                ),
                ListTile(
                  title: const Text('Maximum Extent'),
                  trailing: NumTextField(
                    onChanged: (int? value) {
                      controller.value = controller.value.copyWith(maxExtent: value?.toDouble());
                    },
                  ),
                ),
                ListTile(
                  ...
                  trailing: CupertinoSwitch(
                    ...
                    onChanged: (bool value) {
                      controller.value = controller.value.copyWith(fit: value ? SheetFit.expand : SheetFit.loose);
                    },
                  ),
                ),
              ],
            ...
            ...ListTile.divideTiles(
              ...
              tiles: <Widget>[
                ListTile(
                  title: const Padding(padding: EdgeInsets.only(left: 16, right: 16), child: Text('Child')),
                        ...
                        for (final SheetChildType type in SheetChildType.values)
                          Container(
                            ...
                            child: InkWell(
                              borderRadius: BorderRadius.circular(12),
                              onTap: () {
                                controller.value = controller.value.copyWith(type: type);
                              },
                              child: IgnorePointer(
                                child: FittedBox(
                                  child: SizedBox(
                ...
                ListTile(
                  ...
                  trailing: NumTextField(
                    onChanged: (int? value) {
                      controller.value = controller.value.copyWith(borderRadius: value?.toDouble());
                    },
                    maxNumber: 50,
                  ),
                ),
                ListTile(
                  ...
                  trailing: NumTextField(
                    maxNumber: 50,
                    onChanged: (int? value) {
                      controller.value = controller.value.copyWith(padding: value?.toDouble());
                    },
                  ),
                ),
              ],
              ...
              tiles: <Widget>[
                ListTile(
                  ...
                  trailing: CupertinoSwitch(
                    ...
                    onChanged: (bool value) {
                      controller.value = controller.value.copyWith(bounce: value);
                    },
                  ),
                ),
                ListTile(
                  ...
                  trailing: CupertinoSwitch(
                    ...
                    onChanged: (bool value) {
                      controller.value = controller.value.copyWith(draggable: !value);
                    },
                  ),
                ),
              ],
...
class SectionTitle extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      Padding(padding: const EdgeInsets.all(16), child: Text(text, style: Theme.of(context).textTheme.titleLarge));
}
