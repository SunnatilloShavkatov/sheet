...
class AdvancedSnapSheetPage extends StatefulWidget {
  const AdvancedSnapSheetPage({super.key});
...
class _AdvancedSnapSheetPageState extends State<AdvancedSnapSheetPage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: Stack(
      children: <Widget>[
        Positioned.fill(child: Image.asset('assets/map.png', fit: BoxFit.cover)),
            ...
            builder: (BuildContext context, Widget? child) {
              ...
              return TweenAnimationBuilder<double>(
                ...
                builder: (BuildContext context, double t, Widget? child) {
                  final double elevation = Tween<double>(begin: 4, end: 0).transform(t);
                  final Color? color = ColorTween(
                    begin: Colors.white.withValues(alpha: 0),
                    end: Colors.white,
                  ).transform(t);
                  final Color? borderColor = ColorTween(
                    begin: Colors.grey[200]!.withValues(alpha: 0),
                    end: Colors.grey[200],
                  ).transform(t);
                  return AppBar(
                    elevation: 0,
              ...
              child: Column(
                ...
                children: <Widget>[
                  FloatingActionButton(
                    ...
                    heroTag: 'ggg',
                    onPressed: () {
                      controller.relativeAnimateTo(0.1, duration: Duration(milliseconds: 200), curve: Curves.easeIn);
                    },
    ...
    child: AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget? child) {
        ...
        return TweenAnimationBuilder<double>(
          ...
          duration: Duration(milliseconds: 200),
          builder: (BuildContext context, double t, Widget? child) {
            final double radius = Tween<double>(begin: 16, end: 0).transform(t);
            ...
            return MediaQuery.removePadding(
              ...
              child: DecoratedBox(
                decoration: BoxDecoration(
                  ...
                  color: Colors.white,
                  boxShadow: <BoxShadow>[BoxShadow(color: shadow!, blurRadius: 12)],
                ),
                child: Column(
                  children: <Widget>[
                    Container(
                              ...
                              tiles: List<Widget>.generate(100, (int index) {
                                if (index == 0) {
                                  return Container(
                                    ...
                                    child: Text('Latest near you', style: Theme.of(context).textTheme.titleLarge),
                                  );
                                }
