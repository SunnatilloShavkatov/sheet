...
class Sheet extends StatelessWidget {
  ...
  static SheetState? of(BuildContext context) => SheetScrollable.of(context);
...
class SheetController extends ScrollController {
  ...
  @override
  SheetPosition get position => super.position as SheetPosition;
...
class RenderSheetViewport extends RenderBox
  ...
  @override
  double computeMinIntrinsicHeight(double width) => constraints.maxHeight;
