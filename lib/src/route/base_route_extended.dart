...
class MaterialExtendedPage<T> extends Page<T> {
  ...
  @override
  Route<T> createRoute(BuildContext context) => _PageBasedMaterialPageRoute<T>(page: this);
}
...
class CupertinoExtendedPage<T> extends Page<T> {
  ...
  @override
  Route<T> createRoute(BuildContext context) => _PageBasedCupertinoPageRoute<T>(page: this);
}
